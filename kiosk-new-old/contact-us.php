...
<option value="Zimbabwe">Zimbabwe</option>
      ...
      <?php
		...
		if (isset($_POST['btnsubmit']))
		{
			// submit records 
				...
				$insert = "insert into contactus(name, date, email, job, company, country, phone, message) 
						    values 
						   ('$name', NOW(), '$email','$job','$company','$country','$phone', '$message')";
						
				$run_report = mysqli_query($con, $insert);
			
				$email_from = 'Report Enquery Form';
				$email_subject = 'Report Enquery Form';
				$email_body =  	"Name: $name.\n".
								...
								"Country: $country.\n".
	         					"Message: $message.\n";
				$to="reportocean@gmail.com";
				$headers = "Fropm: $email \r\n";
				$headers .= "Reply-To: $email \r\n";
																	 
				if (mail($to, $email_subject, $email_body, $headers))
				{	
				echo "Thank You.. We received your Message, Our executive will contact you soon...";			
				}
				else
      ...
      ?>    
		...
		<h4 class="title">Contact Details</h4>
          <ul class="contact_details" style='color:#333;'>
          <li style='color:#333;'><i class="fa fa-envelope-o"></i> sales@reportocean.com</li>
          <li style='color:#333;'><i class="fa fa-phone-square"></i> &nbsp;+1 888 212 3539 (US - TOLL FREE)</li>
          <li style='color:#333;'><i class="fa fa-phone-square"></i> &nbsp;+91 999 711 2116 (REST OF WORLD)</li>
          <li style='color:#333;'><i class="fa fa-home"></i> Classic Tower, Rajnagar Extension, Ghaziabad, 201017 - India</li>
        </ul>
        </div></div>
    </div>
    <!-- end form -->
